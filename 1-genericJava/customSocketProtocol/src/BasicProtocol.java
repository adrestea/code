...
public abstract class BasicProtocol {
	...
	public byte[] genContentData() {
		...
		ByteArrayOutputStream baos = new ByteArrayOutputStream(LENGTH_LEN
				+ VER_LEN + TYPE_LEN);
	 ...
	 */
	public int parseContentData(byte[] data) throws ProtocolException, java.net.ProtocolException {
